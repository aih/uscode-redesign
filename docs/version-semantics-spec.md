...
(session 62, BUILDLOG). All four phases are implemented: V1 (session 63, ADR-0074), V2 and V4
(session 65), V3 (session 66, ADR-0075). Implementing sessions update this line and the
