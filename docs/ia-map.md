...
| `/app/about` | `about.astro` | What this site is, and what it is not | `SiteHeader:266`, `SiteFooter:136,149` | `/app/releases`, `/app/docs`, `/app/search/syntax`, OLRC, the repository, the Hugging Face dataset | header, footer |
