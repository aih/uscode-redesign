...
make test-web   # vitest: the USLM renderer, the reference rules, url/cache/preview helpers
make test-e2e   # playwright: what only a browser can answer — the hover preview's three WCAG
