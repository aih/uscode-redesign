...
`make test` = **486** Python tests; `make test-web` = **227** frontend tests; `make test-e2e` = **362**
...
(41 ADRs). Read the entry you need rather than assuming; this file deliberately no longer restates them.
...
Open debts: **the reader has four measured WCAG 2.1 AA failures** (ADR-0039, all in
...
scrolls sideways **3px** at 320 CSS px. The one **critical** and the rest are in the vendored Swagger
