...
`make test` = **486** Python tests; `make test-web` = **213** frontend tests; `make test-e2e` = **109**
...
(38 ADRs). Read the entry you need rather than assuming; this file deliberately no longer restates them.
