...
under collapse it counted versions while the page listed sections. **The mapping is not additive**
— a deploy needs `python -m ingest.reindex_search --recreate` or every new scope is silently empty.
