...
`make test` = **486** Python tests; `make test-web` = **227** frontend tests; `make test-e2e` = **356**
...
(40 ADRs). Read the entry you need rather than assuming; this file deliberately no longer restates them.
