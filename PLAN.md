...
>
> **Next: Day 2 / Session 6, the bulk downloader** — only Title 16 is loaded, at 2 of 382 release points. `Uslm2Parser` still has no table/indent handling (Day 7); `make verify` is still a stub; reader polish (keyboard nav, notes toggles, version timeline, diffs) is Day 4.
